...
<head>
    ...
    <link rel="icon" href='Images\review-background.jpg' type="image/png">
...
<body>
    <header>
        <nav>
            <div class="header-logo"><img src="Images\blood-removebg-preview.png"></div>
    ...
    <footer>
        <div class="siteFooterBar">
            <div class="content1">
                <div class="foot">Donataro2023 © All rights reserved.</div>
            </div>
        </div>
        <div class="footer-content">
            <h3>JOIN OUR CAUSE</h3>
            <p>Donating blood or platelets can be intimidating and even scary. Time to put those hesitations and fears aside. Learn from Donataro and platelet donors how simple and easy it is to roll up a sleeve and help save lives.</p>
            <div class="socials">
                <ul class="sci">
